...
**Variância do traço (Var z):** os valores na geração 100 são substancialmente reduzidos em relação ao valor inicial ($\sigma_z^2 = 1.0$), com reduções médias de 88-90% em todos os regimes de preferência e todos os valores de $A_{max}$. Este padrão é consistente com a ação da seleção viabilidade estabilizadora como principal força sobre $z$ quando a fecundidade é neutra. Notavelmente, a poliandria por si só não mantém variância genética na ausência de benefícios directos.
...
A sigmoide é a **única curva que gera deslocamento significativo de z̄** em relação ao ótimo ecológico. O gradiente $A_{max}=200 > 40 > 10$ indica que a restrição de amostragem atenua, mas não elimina, o deslocamento direcional do traço na curva sigmoide.

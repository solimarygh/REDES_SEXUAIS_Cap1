...
for (k_val in c(10, 5, 20)) {
  sufixo <- if (k_val == 10) "" else sprintf("_k%d", k_val)
  img <- sprintf("Resultados_Artigo/Fase5_MiudoV2/Graficos/Fase4_PlotA_AssinaturaTopologica%s.png", sufixo)
  cat(sprintf("\n#### k = %d\n\n", k_val))
  if (file.exists(img)) {
    cat(sprintf("![](%s)\n\n", img))
  } else {
...
for (k_val in c(10, 5, 20)) {
  sufixo <- if (k_val == 10) "" else sprintf("_k%d", k_val)
  img <- sprintf("Resultados_Artigo/Fase5_MiudoV2/Graficos/Fase4_PlotE_Dumbell_Gen1vsGenFinal%s.png", sufixo)
  cat(sprintf("\n#### k = %d\n\n", k_val))
  if (file.exists(img)) {
    cat(sprintf("![](%s)\n\n", img))
  } else {

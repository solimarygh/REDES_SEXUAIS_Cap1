...
<b>Linha 1:</b> Estrutura da rede (comunidades Louvain) &nbsp;|&nbsp;
<b>Linha 2:</b> Evolução em 3 Atos (distribuições de z e p) &nbsp;|&nbsp;
<b>Esquerda:</b> σp = 0.5 &nbsp;|&nbsp; <b>Direita:</b> σp = 2.0 &nbsp;|&nbsp; A_max = 200
</p>
...
imgs <- file.path(base, c(
  "Rede_uniform_sigmap0.5_Amax200_Gen100.png",
  "Rede_uniform_sigmap2.0_Amax200_Gen100.png",
  "Histogramas_uniform_sigmap0.5_Amax200_Gen100.png",
  "Histogramas_uniform_sigmap2.0_Amax200_Gen100.png"
))
...
base <- "Resultados_Artigo/Redes_Representativas/Graficos"
imgs <- file.path(base, c(
  "Rede_gaussian_sigmap0.5_Amax200_Gen100.png",
  "Rede_gaussian_sigmap2.0_Amax200_Gen100.png",
  "Histogramas_gaussian_sigmap0.5_Amax200_Gen100.png",
  "Histogramas_gaussian_sigmap2.0_Amax200_Gen100.png"
))
existing <- imgs[file.exists(imgs)]
if (length(existing) > 0) knitr::include_graphics(existing) else cat("*Rode o Script 06 primeiro.*")
```
...
base <- "Resultados_Artigo/Redes_Representativas/Graficos"
imgs <- file.path(base, c(
  "Rede_sigmoid_sigmap0.5_Amax200_Gen100.png",
  "Rede_sigmoid_sigmap2.0_Amax200_Gen100.png",
  "Histogramas_sigmoid_sigmap0.5_Amax200_Gen100.png",
  "Histogramas_sigmoid_sigmap2.0_Amax200_Gen100.png"
))
existing <- imgs[file.exists(imgs)]
if (length(existing) > 0) knitr::include_graphics(existing) else cat("*Rode o Script 06 primeiro.*")
```
...
base <- "Resultados_Artigo/Redes_Representativas/Graficos"
imgs <- file.path(base, c(
  "Rede_u-shaped_sigmap0.5_Amax200_Gen100.png",
  "Rede_u-shaped_sigmap2.0_Amax200_Gen100.png",
  "Histogramas_u-shaped_sigmap0.5_Amax200_Gen100.png",
  "Histogramas_u-shaped_sigmap2.0_Amax200_Gen100.png"
))
existing <- imgs[file.exists(imgs)]
if (length(existing) > 0) knitr::include_graphics(existing) else cat("*Rode o Script 06 primeiro.*")
```

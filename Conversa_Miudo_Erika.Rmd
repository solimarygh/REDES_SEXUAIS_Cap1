...
for (k_val in c(10, 5, 20)) {
  img <- sprintf("Resultados_Artigo/Fase5_MiudoV2/Graficos/Fase4_PlotA_AssinaturaTopologica_k%d.png", k_val)
  cat(sprintf("\n#### k = %d\n\n", k_val))
  if (file.exists(img)) {
    cat(sprintf("![](%s)\n\n", img))
  } else {
...
for (k_val in c(10, 5, 20)) {
  img <- sprintf("Resultados_Artigo/Fase5_MiudoV2/Graficos/Fase4_PlotE_Dumbell_Gen1vsGenFinal_k%d.png", k_val)
  cat(sprintf("\n#### k = %d\n\n", k_val))
  if (file.exists(img)) {
    cat(sprintf("![](%s)\n\n", img))
  } else {
